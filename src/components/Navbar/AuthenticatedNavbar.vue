        ...
        <div class="menu-topbar-area">
            ...
            <div class="menu-area">
                <div class="header-logo">
                    <router-link to="index.html"><img alt="image" class="img-fluid"
                            src="/assets/images/header1-logo.svg"></router-link>
                </div>
                <div class="main-menu">
                    <div class="mobile-logo-area d-lg-none d-flex justify-content-between align-items-center">
                        <div class="mobile-logo-wrap">
                            <router-link to="index.html"><img alt="image"
                                    src="/assets/images/header1-logo.svg"></router-link>
                        </div>
                    ...
                    <div class="for-mobile-menu d-lg-none d-block">
                        <div class="sign-in-btn mb-25">
                            <router-link class="primry-btn-1 lg-btn" to="login.html">
                        ...
                        <div class="social-area">
                            <ul>
                                <li><router-link to="https://www.facebook.com/"><i
                                            class="bx bxl-facebook"></i></router-link></li>
                                <li><router-link to="https://twitter.com/"><i class='bx bxl-twitter'></i></router-link></li>
                                <li><router-link to="https://www.linkedin.com/"><i
                                            class='bx bxl-linkedin'></i></router-link></li>
                                <li><router-link to="https://www.instagram.com/"><i
                                            class='bx bxl-instagram'></i></router-link></li>
                    ...
                    <ul>
                        <li>
                            <div class="btn-group dropdown">
                                <div class="notifications-area dropdown-toggle" role="button" id="dropdownMenuButton1"
                                ...
                                <div class="notifacion-card dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            <div class="content">
                                                <h6><router-link to="#">Your application has accepted in 5
...
function logout(e: { preventDefault: () => void; }) {
    e.preventDefault();
    authStore.logout();
}
