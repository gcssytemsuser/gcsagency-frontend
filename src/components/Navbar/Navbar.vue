  ...
  <div class="top-bar2">
    ...
    <div class="top-bar-right">
      <div class="language-select">
        ...
        <ul class="topbar-sublist">
          <li v-for="language in languages" :key="language.name">
            <img :src="language.flag" :alt="`Flag of ${language.name}`" />
      ...
      <div class="social-area">
        <ul>
          <li v-for="link in internalLinks" :key="link.name">
  ...
  <header class="header-area style-3">
    <div class="menu-area">
      <div class="header-logo">
        <router-link to="/"><img alt="image" class="img-fluid" src="/assets/images/header1-logo.svg" /></router-link>
      </div>
      <div class="main-menu">
        ...
        <div class="for-mobile-menu d-lg-none d-block">
          <div class="sign-in-btn mb-25">
            <router-link to="/login" class="primry-btn-1 lg-btn">
        ...
        <ul>
          <li>
            <div class="btn-group dropdown">
              <div class="notifications-area dropdown-toggle" role="button" id="dropdownMenuButton2"
...
import { MenuItemWithoutChildren, MenuItemWithChildren } from "../../types";
import { ref } from "vue";
