  ...
  <div class="top-bar2">
    ...
    <div class="top-bar-right">
      <div class="language-select">
        <img src="/assets/images/icon/flag-eng.svg" alt="image" /><span
          >Language</span
        >
        <ul class="topbar-sublist">
          <li>
            <img src="/assets/images/icon/flag-germeny.svg" alt="image" /><span
              >Germeny</span
            >
          </li>
          <li>
            <img src="/assets/images/icon/flag-french.svg" alt="image" /><span
              >French</span
            >
          </li>
          <li>
            <img src="/assets/images/icon/flag-bangla.svg" alt="image" /><span
              >Bengali</span
            >
          </li>
        </ul>
      ...
      <div class="main-menu">
        ...
        <ul class="menu-list">
          ...
          <li class="menu-item-has-children">
            <a href="#" class="drop-down">Find Jobs</a
            ><i class="bi bi-plus dropdown-icon"></i>
            <ul class="sub-menu">
                ...
                <ul>
                  <li>
                    ...
                    <div class="content">
                      <h6>
                        <a href="#"
                          >Your application has accepted in 5 vacancies.</a
                        >
                      </h6>
                      <span
