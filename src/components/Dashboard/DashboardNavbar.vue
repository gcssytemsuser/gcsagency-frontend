  ...
  <div class="eg-preloder">
    ...
    <header class="header-area style-2">
        <div class="header-main-logo d-lg-block d-none">
            <router-link to="/"><img alt="image" src="/assets/images/header1-logo.svg"></router-link>
        </div>

        <div class="menu-topbar-area">
            <div class="top-bar">
                <p>Welcome Our Job Portal!  <router-link to="bookmark.html">Save Jobs</router-link></p>
                <div class="top-bar-right">
                    ...
                    <div class="social-area">
                        <ul>
                            <li> <router-link to="https://www.facebook.com/"><i class="bx bxl-facebook"></i></router-link></li>
                            <li> <router-link to="https://twitter.com/"><i class='bx bxl-twitter'></i></router-link></li>
                            <li> <router-link to="https://www.linkedin.com/"><i class='bx bxl-linkedin'></i></router-link></li>
                            <li> <router-link to="https://www.instagram.com/"><i class='bx bxl-instagram' ></i></router-link></li>
            ...
            <div class="menu-area">
                <div class="header-logo">
                     <router-link to="index.html"><img alt="image" class="img-fluid" src="/assets/images/header1-logo.svg"></router-link>
                </div>
                <div class="main-menu">
                    ...
                    <ul class="menu-list">
                        <li class="menu-item-has-children">
                             <router-link to="#" class="drop-down">Home</router-link><i class="bi bi-plus dropdown-icon"></i>
                            <ul class="sub-menu">
                                <li> <router-link to="index.html">Home One</router-link></li>
                                <li> <router-link to="index2.html">Home Two</router-link></li>
                                <li> <router-link to="index3.html">Home Three</router-link></li>
                                <li> <router-link to="index4.html">Home Four</router-link></li>
                                <li> <router-link to="index5.html">Home Five</router-link></li>
                                <li> <router-link to="index6.html">Home Six</router-link></li>
                            </ul>
                        </li>
                        <li class="menu-item-has-children">
                             <router-link to="#" class="drop-down">Find Jobs</router-link><i class="bi bi-plus dropdown-icon"></i>
                            <ul class="sub-menu">
                                <li> <router-link to="category.html">Job Category</router-link></li>
                                <li> <router-link to="job-listing1.html">Job Listing 01</router-link></li>
                                <li> <router-link to="job-listing2.html">Job Listing 02</router-link></li>
                                <li> <router-link to="job-details.html">Job Details</router-link></li>
                            </ul>
                        </li>
                        <li class="menu-item-has-children active">
                             <router-link to="#" class="drop-down">Pages</router-link><i class="bi bi-plus dropdown-icon"></i>
                            <ul class="sub-menu">
                                <li><router-link  class="active" to="/user/dashboard">Candidate Dashboard</router-link></li>
                                <li> <router-link to="job-post.html">Post A Jobs</router-link></li>
                                <li> <router-link to="pricing-plan.html">Pricing Plan</router-link></li>
                                <li> <router-link to="faq.html">FAQ</router-link></li>
                                <li> <router-link to="checkout.html">Checkout</router-link></li>
                                <li> <router-link to="error.html">Error</router-link></li>
                                <li> <router-link to=".login">Login</router-link></li>
                                <li> <router-link to="register.html">Register</router-link></li>
                            </ul>
                        </li>
                        <li class="menu-item-has-children">
                             <router-link to="#">Company</router-link><i class="bi bi-plus dropdown-icon"></i>
                            <ul class="sub-menu">
                                <li> <router-link to="company-listing1.html">Company Listing 01</router-link></li>
                                <li> <router-link to="company-listing2.html">Company Listing 02</router-link></li>
                                <li> <router-link to="company-details.html">Company Details</router-link></li>
                                <li> <router-link to="company-dashboard.html">Company Dashboard</router-link></li>
                            </ul>
                        </li>
                        <li class="menu-item-has-children">
                             <router-link to="#">Blog</router-link><i class="bi bi-plus dropdown-icon"></i>
                            <ul class="sub-menu">
                                <li> <router-link to="blog-grid.html">Blog Grid</router-link></li>
                                <li> <router-link to="blog-standard.html">Blog Standard</router-link></li>
                                <li> <router-link to="blog-right-sidebar.html">Blog Right Sidebar</router-link></li>
                                ...
                                <div class="notifacion-card dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            <div class="content">
                                                <h6> <router-link to="#">Your application has accepted in 5 vacancies.</router-link></h6>
                                    ...
                                    <div class="view-all">
                                         <router-link to="#">See All Massages</router-link>
                                    </div>
                                </div>
                            </div>
                        </li>
                        ...
                        <li>
                            <div class="btn-group dropdown">
                                <div class="notifications-area dropdown-toggle" role="button" id="dropdownMenuButton3" data-bs-toggle="dropdown" aria-expanded="false">
                                   <img class="user-icon" src="/assets/images/bg/user-img.png" alt="">
                                </div>
                                <div class="user-card dropdown-menu" aria-labelledby="dropdownMenuButton3">
                                    <ul>
                                        <li>
                                            <router-link  to="my-profile.html">
                                        ...
                                        <li>
                                             <router-link to="view-resume.html">
                                                <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <li>
                                             <router-link to="bookmark.html">
                                                <svg width="16" height="18" viewBox="0 0 16 18" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M13.82 1.24621H13.534V0.368701C13.534 0.165086 13.374 0 13.1767 0H8.00178C7.80442 0 7.6444 0.165086 7.6444 0.368701V1.24621H2.18003C1.10788 1.24621 0 1.83613 0 3.49529V15.7509C0 17.4101 1.12575 18 2.18003 18H13.82C14.8921 18 16 17.4101 16 15.7509V3.49898C16.0036 2.41131 15.4282 1.24621 13.82 1.24621ZM8.35916 0.737403H12.8193V7.20811L10.8179 5.47522C10.6848 5.3593 10.49 5.3593 10.3569 5.47522L8.35559 7.20811L8.35916 0.737403ZM13.8235 17.2626H2.18003C1.63323 17.2626 0.714764 17.0672 0.714764 15.7509V3.49898C0.714764 2.18271 1.63323 1.9873 2.18003 1.9873H7.6444V8.00819C7.64408 8.21181 7.80383 8.37717 8.0012 8.37749C8.08496 8.37763 8.16613 8.3474 8.2305 8.29209L10.5892 6.25317L12.9479 8.29209C13.0996 8.42243 13.3249 8.40123 13.4513 8.24476C13.5049 8.17835 13.5342 8.09461 13.534 8.00819V1.98361H13.82C15.0958 1.98361 15.2852 2.93118 15.2852 3.49529L15.2888 15.7509C15.2888 17.0672 14.3703 17.2626 13.8235 17.2626Z"></path>
                                                    <path d="M6.3003 4.52417H2.03316C1.8358 4.52417 1.67578 4.68926 1.67578 4.89287C1.67578 5.09649 1.8358 5.26157 2.03316 5.26157H6.3003C6.49767 5.26157 6.65768 5.09649 6.65768 4.89287C6.65768 4.68926 6.49767 4.52417 6.3003 4.52417Z"></path>
                                                    <path d="M6.3003 7.04224H2.03316C1.8358 7.04224 1.67578 7.20732 1.67578 7.41094C1.67578 7.61455 1.8358 7.77964 2.03316 7.77964H6.3003C6.49767 7.77964 6.65768 7.61455 6.65768 7.41094C6.65768 7.20732 6.49767 7.04224 6.3003 7.04224Z"></path>
                                                    <path d="M13.3336 9.5603H2.03316C1.8358 9.5603 1.67578 9.72539 1.67578 9.929C1.67578 10.1326 1.8358 10.2977 2.03316 10.2977H13.3336C13.5309 10.2977 13.691 10.1326 13.691 9.929C13.691 9.72539 13.5309 9.5603 13.3336 9.5603Z"></path>
                                                    <path d="M13.3336 12.0645H2.03316C1.8358 12.0645 1.67578 12.2295 1.67578 12.4332C1.67578 12.6368 1.8358 12.8019 2.03316 12.8019H13.3336C13.5309 12.8019 13.691 12.6368 13.691 12.4332C13.691 12.2295 13.5309 12.0645 13.3336 12.0645Z"></path>
                                                    <path d="M13.3336 14.6006H2.03316C1.8358 14.6006 1.67578 14.7657 1.67578 14.9693C1.67578 15.1729 1.8358 15.338 2.03316 15.338H13.3336C13.5309 15.338 13.691 15.1729 13.691 14.9693C13.691 14.7657 13.5309 14.6006 13.3336 14.6006Z"></path>
                                                </svg>
                                                Bookmark Jobs
                                            </router-link>
                                        </li>
