                        ...
                        <div class="job-widget mb-20">
                            <div class="check-box-item">
                                ...
                                <div class="salary-container">
                                    <ul>
                                        <li>
                                            <input class="form-check-input" type="radio" id="salary-1" name="showInputBox"
                                                value="salary-1">
                                            <div class="content">
                                        ...
                                        <li>
                                            <input class="form-check-input" type="radio" id="salary-2" name="showInputBox"
                                                value="salary-2">
                                            <div class="content">
                                        ...
                                        <li>
                                            <input class="form-check-input" type="radio" id="salary-3" name="showInputBox"
                                                value="salary-3">
                                            <div class="content">
                                        ...
                                        <li>
                                            <input class="form-check-input" type="radio" id="salary-4" name="showInputBox"
                                                value="salary-4">
                                            <div class="content">
                                        ...
                                        <li>
                                            <input class="form-check-input" type="radio" id="salary-5" name="showInputBox"
                                                value="salary-5">
                                            <div class="content">
                                    ...
                                    <div class="job-top">
                                        <div class="job-list-content">
                                            <div class="company-area">
                                                ...
                                                <div class="company-details">
                                                    <div class="name-location">
                                                        <h5><a href="job-details.html">Mern Stack Developer</a></h5>
                                                        <p><a href="company-details.html">Germain Group Ltd</a></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="job-discription">
