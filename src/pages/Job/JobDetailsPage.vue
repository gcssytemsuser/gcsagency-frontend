            ...
            <div class="row g-lg-4 gy-5">
                <div class="col-lg-8">
                    <div class="job-details-content">
                        ...
                        <p><span>Job Description:</span> A UI/UX (User Interface/User Experience) designer is responsible
                            for designing and creating engaging and effective interfaces for software and web applications.
                            This includes designing the layout, visual design, and interactivity of the user interface.</p>
                        <br>
                        <p><span>Job Responsibility:</span> Collaborating with cross-functional teams: UI/UX designers often
                            work closely with other teams, including product management, engineering, and marketing, to
                            ensure that the user interface is aligned with business and technical requirements. You will
                            need to be able to effectively communicate your design ideas and gather feedback from other team
                            members.</p>
                        <ul>
                            ...
                            <li>Collaborating with cross-functional teams, including product management, engineering, and
                                marketing.</li>
                        ...
                        <ul>
                            ...
                            <li>Developing and maintaining design systems and style guides to ensure consistency in theux
                            </li>
                            <li>Collaborating with cross-functional teams, including product management, engineering, and
                                marketing, to ensure that the user interface is aligned with business and technical
                                requirements</li>
                        </ul>
                        <p><span>Extra Benefits:</span> Some specific tasks that a UI/UX designer might be responsible for
                            include:</p>
                        <ul>
                ...
                <div class="col-lg-4">
                    <div class="job-details-sidebar mb-120">
                        ...
                        <div class="view-job-btn mb-30">
                            <a href="job-listing1.html"><img src="/assets/images/icon/company-2.svg" alt="">View All Jobs In
                                This Company</a>
                        </div>
                        ...
                        <div class="swiper company-gallery-slider" data-cursor="Drag">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <a href="/assets/images/bg/company-gallery-big-01.png" data-fancybox="gallery"
                                        class="gallery2-img">
                                ...
                                <div class="swiper-slide">
                                    <a href="/assets/images/bg/company-gallery-big-02.png" data-fancybox="gallery"
                                        class="gallery2-img">
                                        <div class="gallery-wrap">
                                ...
                                <div class="swiper-slide">
                                    <a href="/assets/images/bg/company-gallery-big-03.png" data-fancybox="gallery"
                                        class="gallery2-img">
                                        <div class="gallery-wrap">
                                ...
                                <div class="swiper-slide">
                                    <a href="/assets/images/bg/company-gallery-big-04.png" data-fancybox="gallery"
                                        class="gallery2-img">
                                        <div class="gallery-wrap">
                                ...
                                <div class="swiper-slide">
                                    <a href="/assets/images/bg/company-gallery-big-05.png" data-fancybox="gallery"
                                        class="gallery2-img">
                                        <div class="gallery-wrap">
                                    ...
                                    <div class="feature-card">
                                        ...
                                        <div class="job-discription">
                                            <ul>
                                                ...
                                                <li>
                                                    <img src="/assets/images/icon/arrow2.svg" alt="">
                                                    <p><span class="title">Vacancy:</span> <span> 05 Person (Both)</span>
                                                    </p>
                                                </li>
                                                <li>
                                                    <img src="/assets/images/icon/arrow2.svg" alt="">
                                                    <p><span class="title">Deadline:</span> <span> 02 March, 2023 </span>
                                                    </p>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <div class="feature-card">
                                        ...
                                        <div class="job-discription">
                                            <ul>
                                                ...
                                                <li>
                                                    <img src="/assets/images/icon/arrow2.svg" alt="">
                                                    <p><span class="title">Vacancy:</span> <span> 07 Person (Female)</span>
                                                    </p>
                                                </li>
                                                <li>
                                                    <img src="/assets/images/icon/arrow2.svg" alt="">
                                                    <p><span class="title">Deadline:</span> <span> 03 March, 2023 </span>
                                                    </p>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <div class="feature-card">
                                        ...
                                        <div class="job-discription">
                                            <ul>
                                                ...
                                                <li>
                                                    <img src="/assets/images/icon/arrow2.svg" alt="">
                                                    <p><span class="title">Vacancy:</span> <span> 01 Person (Both)</span>
                                                    </p>
                                                </li>
                                                <li>
                                                    <img src="/assets/images/icon/arrow2.svg" alt="">
