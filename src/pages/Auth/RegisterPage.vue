                                ...
                                <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab"> 
                                    <form>
                                        <div class="row">
                                            ...
                                            <h6>Already have an account? <router-link  to="login.html"> Login</router-link> Here</h6>
                                            <div class="login-difarent-way">
                                                <div class="row g-4">
                                                    <div class="col-md-6">
                                                        <router-link  to="https://myaccount.google.com/"><img src="/assets/images/icon/google1.svg" alt="">Log in with Google</router-link>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <router-link  to="https://www.facebook.com/"><img src="/assets/images/icon/facebook1.svg" alt="">Log in with Facebook</router-link>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
