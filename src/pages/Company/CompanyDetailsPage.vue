            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="post-thumb">
                        <img class="img-fluid" src="/assets/images/bg/blog-dt-img.png" alt="">
                    ...
                    <div class="company-area">
                        <div class="company-info">
                            ...
                            <ul>
                                <li><img src="/assets/images/icon/map-2.svg" alt=""> Dhaka, Bangladesh</li>
                        ...
                        <div class="company-contact">
                            ...
                            <div class="social-area">
                                <p><img src="/assets/images/icon/share-icon.svg" alt="">Follow Company:</p>
                                <ul>
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="company-details-content">
                                <h5>About Company</h5>
                                <p>A software company is a business that develops and sells computer software. Some software
                                    companies specialize in a particular type of software, such as operating systems,
                                    productivity tools, or games, while others develop a range of software products. Many
                                    software companies also offer services such as custom software development, consulting,
                                    and technical support to their customers. The size and scope of software companies can
                                    vary greatly, from small startups to large multinational corporations.</p>
                                <br><br>
                                <h5>Working Area</h5>
                        ...
                        <div class="col-lg-4">
                            <div class="company-dt-sb mb-60">
                                ...
                                <a class="primry-btn-2 lg-btn" href="job-listing1.html">Job Available 23</a>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="col-lg-12 mb-30">
                        <div class="job-listing-card">
                            ...
                            <div class="job-type-apply">
                                <p><img src="/assets/images/icon/company-4.svg" alt=""> Job Applied: <span> 07 Person</span>
                                </p>
                                <div class="job-type">
                    ...
                    <div class="col-lg-12 mb-30">
                        <div class="job-listing-card">
                            <div class="job-top">
                                <div class="job-list-content">
                                    <div class="company-area">
                                        ...
                                        <div class="company-details">
                                            <div class="name-location">
                                                <h5><a href="job-details.html">Senior PHP Developer</a></h5>
                                                <p><a href="company-details.html">Marko Land Conpany</a></p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="job-discription">
                                        <ul>
                                            ...
                                            <li>
                                                <p><span class="title">Salary:</span> $50K-$70K / <span class="time">Per
                                                        Month</span></p>
                                            </li>
                                        </ul>
                                        <ul>
                            ...
                            <div class="job-type-apply">
                                <p><img src="/assets/images/icon/company-4.svg" alt=""> Job Applied: <span> 05 Person</span>
                                </p>
                                <div class="job-type">
                                    <span class="light-yellow">Full Time</span>
                                    <span class="light-purple">Part Time</span>
                    ...
                    <div class="col-lg-12 mb-30">
                        <div class="job-listing-card">
                            <div class="job-top">
                                <div class="job-list-content">
                                    <div class="company-area">
                                        ...
                                        <div class="company-details">
                                            <div class="name-location">
                                                <h5><a href="job-details.html">Junior React Developer</a></h5>
                            ...
                            <div class="job-type-apply">
                                <p><img src="/assets/images/icon/company-4.svg" alt=""> Job Applied: <span> 06 Person</span>
                                </p>
                                <div class="job-type">
                                    <span class="light-purple">Part Time</span>
                                </div>
                    ...
                    <div class="col-lg-12 mb-60">
                        <div class="job-listing-card">
                            <div class="job-top">
                                <div class="job-list-content">
                                    <div class="company-area">
                                        ...
                                        <div class="company-details">
                                            <div class="name-location">
                                                <h5><a href="job-details.html">Senior React Developer</a></h5>
                                                <p><a href="company-details.html">UI.UX Company</a></p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="job-type-apply">
                                <p><img src="/assets/images/icon/company-4.svg" alt=""> Job Applied: <span> 08 Person</span>
                                </p>
                                <div class="job-type">
                                    <span class="light-yellow">Full Time</span>
                                    <span class="light-purple">Part Time</span>
